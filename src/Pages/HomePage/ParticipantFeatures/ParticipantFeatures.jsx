...
const ParticipantFeatures = () => {
    return (
        <div className='py-20'>
            <section className="bg-gradient-to-br from-primary/40 to-secondary/30 py-12 px-4 md:px-8 w-full md:w-10/12 mx-auto rounded-2xl hover:shadow-2xl transition-all duration-300 ease-in-out ">
