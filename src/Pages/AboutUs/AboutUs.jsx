    ...
    return (
        <div className='min-h-screen'>
            <div className="max-w-5xl mx-auto px-4 py-12">
                <h2 data-aos="fade-up" className="text-3xl md:text-4xl font-bold text-center mb-6 text-primary/70">About MediCamp</h2>
                <p data-aos="fade-up" data-aos-delay="100" className="text-lg text-center mb-8">
                ...
                <div data-aos="fade-up" data-aos-delay="200" className="grid md:grid-cols-3 gap-6 mt-10 text-center">
                    <div className="p-6 shadow-xl bg-base-100 rounded-lg hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
