...
const AboutUs = () => {
    return (
        <div data-aos="fade-up" className="max-w-5xl mx-auto px-4 py-12">
            <h2 className="text-4xl font-bold text-center mb-6">About MediCamp</h2>
            ...
            <div className="grid md:grid-cols-3 gap-6 mt-10 text-center">
                <div className="p-6 shadow-xl rounded-lg bg-white">
                    ...
                    <p className="text-gray-600">To provide accessible medical care through organized and reliable camp systems.</p>
                </div>
                <div className="p-6 shadow-xl rounded-lg bg-white">
                    <h3 className="text-xl font-bold mb-2">🌍 Vision</h3>
                    <p className="text-gray-600">Empowering rural and underserved communities with health services.</p>
                </div>
                <div className="p-6 shadow-xl rounded-lg bg-white">
                    <h3 className="text-xl font-bold mb-2">🤝 Our Team</h3>
                    <p className="text-gray-600">Organizers, participants & healthcare professionals working together to improve lives.</p>
                </div>
            </div>
        </div>
    );
